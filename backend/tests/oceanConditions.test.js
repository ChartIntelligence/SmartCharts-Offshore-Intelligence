...

{
  ...
  const candidate = {
    id: "open-water-live-foundation-1",
...

{
  ...
  const candidate = {
    id: "open-water-invalid-coordinates-1",
...

{
  ...
  const candidate = {
    id: "open-water-whitespace-coordinates-1",
...
{
  const candidate = {
    id: "open-water-provider-unavailable-1",
...

{
  ...
  const candidate = {
    id: "open-water-provider-failure-1",
...

{
  ...
  const candidates = [
    {
      id:
        "open-water-composition-success-1",
    ...
    {
      id:
        "open-water-composition-failure-1",
  ...
  const oceanConditionsProvider =
    async (
      ...
      if (
        ...
        throw new Error(
          "simulated-composition-provider-failure"
        );
      }
  ...
  assert.equal(
    result.evaluation
      .results[0].value.oceanConditions,
    fakeOceanConditions
  );
  ...
  assert.equal(
    result.evaluation
      .results[0].value.speciesOpportunity,
    undefined
  );
  ...
  assert.equal(
    result.evaluation
      .results[0].value.eligibleForRanking,
    undefined
  );
...

{
  ...
  assert.equal(
    result.candidate,
    speciesInterpretation.candidate
  );
}


{
  const highScoreOpportunity = {
    available: true,
  ...
  const speciesInterpretation = {
    ...
    candidate: {
      id:
        "ranking-input-high-score-ineligible-1"
    },
  ...
  const excludedHighScore =
    resolveUnifiedOpportunityRankingInputV1({
      speciesInterpretation: {
        ...
        candidate: {
          id:
            "ranking-composition-excluded-1"
        },
  ...
  const eligibleLowerScore =
    resolveUnifiedOpportunityRankingInputV1({
      speciesInterpretation: {
        ...
        candidate: {
          id:
            "ranking-composition-eligible-1"
        },
...

{
  ...
  assert.match(
    result.sections
      .waterColorAndWaterCharacter
      .observed,
    /clear-blue surface-water character/i
  );
...

{
  ...
  assert.match(
    result.sections
      .waterColorAndWaterCharacter
      .observed,
    /transition in surface-water character/i
  );
  ...
  assert.match(
    result.sections
      .waterColorAndWaterCharacter
      .limited,
    /does not by itself establish/i
  );
}
      ...
      intelligenceTranslation: {
        ...
        sections: {
          ...
          waterColorAndWaterCharacter: {
            ...
            evidence: {
              classification:
                "future-water-character-classification"
            }
          }
        }
      }
    ...
    presentedOpportunities: [
      {
        ...
        location: {
          id:
            "unified-opportunity-intelligence-unavailable-1"
        },
    ...
    presentedOpportunities: [
      {
        ...
        location: {
          id:
            "unified-opportunity-intelligence-unresolved-1"
        },
 ...
 * ------------------------------------------------------------
 *
 * Observation preserves one governed candidate/species
 * evaluation without creating persistence, lifecycle state,
 * captain-facing opportunity status, or rank.
 */
...

{
  const speciesInterpretation = {
    ...
    candidate: {
      ...
      name:
        "Observation Eligible Candidate"
    },
  ...
  assert.equal(
    observation.minimumEvidenceGate
      .eligibleForRanking,
    true
  );
  ...
  console.log(
    "PASS governed opportunity observation preserves an eligible evaluation without assigning rank or lifecycle state"
  );
}
...

{
  const speciesInterpretation = {
    ...
    candidate: {
      ...
      name:
        "Observation Excluded Candidate"
    },
  ...
  console.log(
    "PASS governed opportunity observation preserves gate-failed candidate evidence and exclusion reasons"
  );
}
...

{
  ...
  const mismatchedInterpretation = {
    available: true,
  ...
  console.log(
    "PASS governed opportunity observation fails closed on candidate identity mismatch"
  );
}
